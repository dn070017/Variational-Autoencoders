...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        help='coefficient for KL divergence used in beta-VAE (Higgins et al., 2017), default: (1.0)')
    parser.add_argument(
    ...
    parser.add_argument(
        '--num_generated_image', type=int, default=16, dest='test_size',
...
def main(beta, num_epochs, train_size, batch_size, latent_dim, test_size, outdir, show_images):
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        for test_x in test_dataset:
            total_loss, reconstructed_loss, kl_divergence = beta_vae_loss(model, test_x)
...
if __name__ == "__main__": 
    ...
    # from command line
    main(
        args.beta, args.num_epochs, args.train_size, args.batch_size, args.latent_dim, args.test_size, args.outdir, show_images=False
    )
else:
